...
from app.features.organization.identity.tenant.schemas.tenant import OrgTenantCreate
...
from app.features.organization.identity.infos.models.infos import OrgInfos
